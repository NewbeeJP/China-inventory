  ...
  return (
    <div className="p-4">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
        <p className="text-sm text-gray-500">一次装柜/一次进货整批登记，共 {batches.length} 批</p>
      ...
      {batches.length === 0 ? (
        <p className="py-8 text-center text-sm text-gray-400">还没有批次，点右上角新建一个</p>
      ) : (
          ...
          <table className="w-full min-w-[640px] border-collapse text-sm">
            <thead>
              <tr className="border-b border-gray-300 text-left text-gray-500">
                ...
                <th className="px-2 py-2 font-medium">批次名称</th>
